...
const OCCASION_OPTIONS = [
    "Compleanno", "Addio al celibato/nubilato", "Matrimonio / after-party", "Aziendale / corporate", "Lancio prodotto", "Cena privata", "Altro",
];
...
export default function PrivateEvents() {
    ...
    return (
        <div>
            <Seo title="Prenota il tuo Evento — Glitz Club" description="Eventi privati al Glitz Club: matrimoni, compleanni, aziendali, lanci prodotto. 4 zone o tutto il club, fino a 2000 persone." />

            <section className="max-w-7xl mx-auto px-4 sm:px-6 pt-8 pb-12">
                <div className="space-y-4">
                    <span className="overline-tag">Eventi Privati</span>
                    <h1 data-testid="private-title" className="text-4xl sm:text-5xl lg:text-6xl font-black uppercase tracking-tight leading-none">
                        Prenota il tuo <span className="bg-gradient-to-r from-lava to-sunset-pink bg-clip-text text-transparent">Evento</span>
                    </h1>
                    <p className="text-white/60 max-w-2xl text-base sm:text-lg leading-relaxed">
                        Il Glitz Club apre le sue quattro zone per il tuo evento privato. Compleanni, matrimoni, aziendali, lanci prodotto — con vista sull'Isola di Dino e la nostra macchina organizzativa. Fino a 2000 ospiti.
                    </p>
                </div>
            </section>
            ...
            <section className="max-w-3xl mx-auto px-4 sm:px-6 pb-24">
                {sent ? (
                    ...
                    >
                        ...
                        <h2 data-testid="private-success" className="text-2xl sm:text-3xl font-black uppercase tracking-tight">Richiesta ricevuta!</h2>
                        <p className="text-white/70 max-w-md mx-auto">
                            Il nostro event manager ti risponderà entro 24h con disponibilità, preventivo dettagliato e possibilità di sopralluogo.
                        </p>
