...
export function createLogo(width=1.85,depth=.045,wordmarkOnly=false,strokeExpansion=0){
 ...
 for(const shape of path.toShapes(true)){const mesh=new THREE.Mesh(new THREE.ExtrudeGeometry(shape,{depth,bevelEnabled:strokeExpansion>0,bevelSize:strokeExpansion,bevelThickness:.008,bevelSegments:2,curveSegments:20}),material);mesh.name='Logo originale vettoriale';group.add(mesh)}
 }
